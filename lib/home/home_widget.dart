...
class _HomeWidgetState extends State<HomeWidget> {
  ...
  void initState() {
    ...
    _model.txtProductoController = TextEditingController();
  }
      ...
      body: SafeArea(
        child: GestureDetector(
          ...
          child: Column(
            ...
            children: [
              TextFormField(
                controller: _model.txtProductoController,
                autofocus: true,
                obscureText: false,
                ...
                validator:
                    _model.txtProductoControllerValidator.asValidator(context),
              ),
              FFButtonWidget(
                onPressed: () async {
                  final productosCreateData = createProductosRecordData(
                    nombre: _model.txtProductoController.text,
                  );
                  ...
                  await showDialog(
                    ...
                    builder: (alertDialogContext) {
                      return AlertDialog(
                        title: Text('Deseaea agregar un producto'),
                        actions: [
                          TextButton(
